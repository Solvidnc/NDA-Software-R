    ...
    if (!isValidEmail(signinemail)) {      
      ...
      if (passwordStrength === 'Strong') {
            ...
            setPasswordValidate(true);
              // Attempt to retrieve the "wrongpassword" item from localStorage
              let wrongpsdarray = localStorage.getItem("wrongpassword");

              // Check if it's not null and parse it, or initialize as an empty array
              let wrongps = wrongpsdarray ? JSON.parse(wrongpsdarray) : [];
                  ...
                  <div className="mb-8">
                    ...
                    <input
                      ...
                      placeholder="Enter your Password"
                        style={{borderColor:(passwordStrength==="Weak" || passwordStrength==="Moderate") && "red"}}
                      onChange={(e) => { setPassWord(e.target.value), validatePasswordStrength(password); }}
                      className="border-stroke dark:text-body-color-dark dark:shadow-two w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none transition-all duration-300 focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:focus:border-primary dark:focus:shadow-none"
                    />
                    <p style={{
                                lineHeight: "16px",
                            ...
                            {passwordValidate && (
                                <p style={{ fontSize: "12px", marginTop: "5px", color: passwordStrength === 'Strong' ? 'green' : passwordStrength === 'Moderate' ? 'orange' : 'red' }}>
