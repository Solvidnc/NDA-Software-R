...
const featuresData: Feature[] = [
  ...
  },
  {
    ...
    paragraph:
      "For yours, and similar things, are the result of the expedient exercise of those who praise them. Should anyone ever be repelled by their wisdom, not in time? He flees and repels as his elders.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Services",
    paragraph:
      "Your digital transformation starts here. Our technology experts help you find the IT support services that work for your particular needs. We have many solutions waiting to scale your business for future growth.  ",
  },
